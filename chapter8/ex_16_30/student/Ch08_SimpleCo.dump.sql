...
INSERT INTO `CUSTOMER` VALUES (1000,'Smith','Jeanne',2860.43,'1989-03-15'),(1001,'Ortega','Juan',1291.72,'1988-12-22'),(1002,'Rauthor','Peter',0.00,NULL),(2000,'Powers','Ruth',500.00,NULL);
...
INSERT INTO `INVOICE` VALUES (8006,1000,'2022-04-30',301.72);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_updatecustbalance2` AFTER DELETE ON `INVOICE` FOR EACH ROW BEGIN
    UPDATE CUSTOMER
...
-- Dump completed on 2025-06-15  4:00:13
