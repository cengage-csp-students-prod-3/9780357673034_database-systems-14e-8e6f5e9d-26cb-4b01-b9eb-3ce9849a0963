...
INSERT INTO `CUSTOMER` VALUES (1000,'Smith','Jeanne',1653.55,'1989-03-15'),(1001,'Ortega','Juan',1291.72,'1988-12-22'),(1002,'Rauthor','Peter',0.00,NULL),(2000,'Powers','Ruth',500.00,NULL);
...
INSERT INTO `INVOICE` VALUES (8000,1000,'2022-03-23',235.89),(8001,1001,'2022-03-23',312.82),(8002,1001,'2022-03-30',528.10),(8003,1000,'2022-04-16',194.78),(8004,1000,'2022-04-23',619.44),(9000,1001,'2022-05-07',225.40),(9001,1000,'2022-04-30',301.72),(9002,1000,'2022-04-30',301.72);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_updatecustbalance` AFTER INSERT ON `INVOICE` FOR EACH ROW BEGIN
                        UPDATE CUSTOMER
...
-- Dump completed on 2025-06-15  3:51:58
