...
ALTER TABLE ACTIVE_DRIVERS
MODIFY DRIVER_FIRST_NAME VARCHAR(20),
MODIFY DRIVER_LAST_NAME VARCHAR(20),
MODIFY DRIVER_DRIVING_LICENSE_ID VARCHAR(10),
MODIFY DRIVER_DRIVING_LICENSE_CHECKED BOOL,
MODIFY DRIVER_RATING DECIMAL(2,1);
...
/*8 - 1 - 4 */
ALTER TABLE MAINTENANCE_TYPES
ALTER COLUMN MAINTENANCE_PRICE SET DEFAULT 0.00;
ALTER TABLE MAINTENANCE_TYPES
