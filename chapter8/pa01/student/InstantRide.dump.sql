...
CREATE TABLE `ACTIVE_DRIVERS` (
  ...
  `MAINTENANCE_PRICE` decimal(5,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`DRIVER_ID`),
  UNIQUE KEY `DuplicateCheck` (`DRIVER_FIRST_NAME`,`DRIVER_LAST_NAME`,`DRIVER_DRIVING_LICENSE_ID`),
  KEY `NameSearch` (`DRIVER_FIRST_NAME`,`DRIVER_LAST_NAME`,`DRIVER_DRIVING_LICENSE_ID`)
...
INSERT INTO `ACTIVE_DRIVERS` VALUES ('2001','Willie','Butler','1874501',1,4.4,0.00),('2002','Justin','Howard','1953853',1,4.8,0.00),('2003','Anthony','Walker','1735487',1,3.5,0.00);
...
-- Dump completed on 2025-06-09 17:58:51
