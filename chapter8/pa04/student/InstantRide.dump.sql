...
INSERT INTO `MAINTENANCES` VALUES ('1001','1','2020-12-31'),('1001','2','2020-06-01'),('1003','2','2020-06-01');
...
--
/*!50003 DROP FUNCTION IF EXISTS `DRIVER_STATUS` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `DRIVER_STATUS`(driver_id_param INT) RETURNS varchar(10) CHARSET utf8mb4
    READS SQL DATA
BEGIN
...
-- Dump completed on 2025-06-11  6:09:14
